...
<table>
	<tr>
		<td align="center" style="color: #2779aa;"><s:text
				name="pts.resources" /></td>
		<td style="width: 50px;">&nbsp;</td>
		<td align="center" style="color: #2779aa;"><s:text
				name="pts.assigned.resources" /></td>
	</tr>
	<tr>
		<td><s:select list="employeeMap" name="employeeNames"
		...
		<td><s:select list="selectedEmployeesMap"
				name="selectedEmployeeNames" theme="simple" multiple="true"
