...
<body onload="calculateOriginalLOE()">
	<s:form id="createNetworkCodeFormId" method="POST"
		onsubmit="settotalLOE()" action="../projects/modifyNetworkCode.action"
		theme="simple">
								...
								<td align="center">
									<table cellspacing="10">
										...
										<tr>
											...
											<!-- <td><sj:autocompleter
													list="#{'Early Start':'Early Start','Execution':'Execution','Warranty':'Warranty','Cancelled':'Cancelled','Implemented':'Implemented'}"
													name="status" theme="simple" id="statusId"
										...
										<!-- 			<tr>
											<td style="color: #2779aa;" align="right">Is it For
												intern:</td>
											<td><input type="checkbox" name="isForinterns" value="isForinterns"
												id="isForinterns" /></td>
										</tr> -->
										<tr>
											<td style="color: #2779aa;" align="right"><s:text
