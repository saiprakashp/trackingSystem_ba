<%@ taglib prefix="sjg" uri="/struts-jquery-grid-tags"%><%@taglib
...
<sjg:grid id="gridmultitable"
	...
	navigatorExtraButtons="{
			...
			edit : { 
	    		...
	    		icon: 'ui-icon-pencil',
	    		position:'first',
	    		onclick: function(){ macdUser('goViewNetworkCode'); }
    		}
    		
    	}"
	rowList="20,50,100,150,200"
	rowNum="%{#session.rowNum == null? 20 : #session.rowNum}"
	multiselect="false" editurl="../projects/networkMACDOperation.action"
	...
	<sjg:gridColumn name="id" index="id" title="Id" hidden="true"
		editable="true" />
	<sjg:gridColumn name="TFSEpic" index="TFSEpic" title="TFSEpic" hidden="false"
		editable="true" />
	...
	<sjg:gridColumn name="pillar" index="pillarName" search="false"
		title="Products" sortable="true" editable="true" edittype="select"
	...
	<sjg:gridColumn name="totalLOE" index="totalLOE" search="false"
		title="Total LOE" sortable="true" hidden="false" />
