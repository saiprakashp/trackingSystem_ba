...
<body>
	<s:form theme="simple" method="POST" id="compScoreReportFormId">
		...
		<div id="breadcrumbDivParent"
			...
			<div
				...
				<div id="breadcrumbDiv" style="margin-left: 25px; clear: both;">
					...
					>
					<s:text name="pts.menu.comp.score.report" />
				</div>
			</div>
		</div>
		...
		<div id="contentarea">
			<DIV style="margin: 0 auto; width: 980px;">
				...
				<div>
					<table>
						<tr>
							...
							<td class="ptslabel" align="right" nowrap="nowrap"><s:text
									name="pts.user.platform" />:</td>
							<td width="200"><sj:autocompleter
									list="#session['platformsMap']" name="pillarId" listKey="key"
							...
							<td  width="200"><sj:autocompleter list="#session['projectsMap']"
									name="projectId" listKey="key" listValue="value"
									theme="simple" id="projectId" selectBox="true"
									selectBoxIcon="true"></sj:autocompleter></td>
							<td align="left" width="200"><sj:autocompleter
							...
							<td style="padding-left: 20px;"><s:submit theme="simple"
									...
									onclick="submitForm('../reports/compScoreReport.action')" /></td>
						</tr>
					</table>
				</div>
				<div id="spacer10px">&nbsp;</div>
				<table style="width: 100%;">
					<tr>
						<td><jsp:include page="compScoreReportGrid.jsp" /></td>
					</tr>
				</table>
			</div>
