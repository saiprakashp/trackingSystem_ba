...
<script>
	function submitUserUtilizationForm() {
		...
		if (fromDate > toDate) {
			...
			document.forms[0].action = '../utilization/ricoUtilizationReport.action';
		...
		<div id="contentarea">
			<DIV style="margin: 0 auto; width: 980px;">
				...
				<div>
					<table>
						<tr>
							...
							<td width="200" align="left"><sj:autocompleter list="projectManagers"
							...
							<td align="right" colspan="1"><s:a
									style="float: right;margin-left: 2px !important"
									href="javascript:void(0)" onclick="submitUserUtilizationForm()">
									<img style="float: right;" src="../images/go.png">
								</s:a></td>
						</tr>
					</table>
				</div>
				...
				<table style="width: 100%;">
					<tr>
						<td><jsp:include page="ricoUtilizationGrid.jsp" /></td>
					</tr>
				</table>
			</DIV>
			<div id="spacer10px">&nbsp;</div>
