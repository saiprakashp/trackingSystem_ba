					...
					<table>
						<tr>
							...
							<td align="left" width="200"><sj:autocompleter
									list="activityList" name="selectedEmployee" listKey="id"
									listValue="name" theme="simple" id="employeeListId"
							...
							<td style="padding-left: 20px;"><sj:submit
									...
									href="../utilization/goResourceEffortDetails.action"
