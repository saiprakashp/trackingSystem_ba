...
<sjg:grid id="gridmultitable" href="../user/ajaxManageUser.action"
	...
	<sjg:gridColumn name="stableTeamName" cssClass="stableTeamName"
		index="StableTeamName" width="120" title="Stable Team" sortable="true" />
	<sjg:gridColumn name="stableContribution" cssClass="stableContribution"
		index="StableTeam" width="120" title="Stable Team" sortable="true" />
