...
<body>
	<s:form id="myProfile" method="POST" action="../user/addUser.action"
		theme="simple">
									...
									<table cellspacing="10">
										...
										<tr>
											...
											<td colspan="3"><s:textfield name="name" id="name"
													theme="simple" cssStyle="width:290px;"></s:textfield></td>
											<td class="ptslabel" align="right"><s:text
											...
											<td colspan="4" valign="top" align="right">
												<table>
													...
													<div style="float: left;">
														<label style="display: block;font-size: 15px; font-weight: bold;">
															Contribution and Domain[Score] </label>
													</div>
													</td></tr>
													<tr><td>
													<div style="float: left; ">
														<label for="CX" style="display: block;" class="ptslabel">CX</label> <s:textfield
															id="cxContribution" name="cxContribution" style="width:70px;"/>
													</div>
													</td>
													<td>
													<div style="float: left;">
														<label for="Conf" style="display: block;" class="ptslabel">Conf</label> <s:textfield
															id="confContribution" name="confContribution" style="width:70px;"/>
													</div>
													</td>
													<td>
													<div style="float: left;">
														<label for="IPCOMMS" style="display: block;" class="ptslabel">IPCOMMS</label> <s:textfield
															id="voipContribution" name="voipContribution" style="width:70px;"/>
													</div>
													</td>
													<td>
													<div style="float: left;">
														<label for="IPCOMMS-NSRS" style="display: block;" class="ptslabel">IPCOMMS-NSRS</label> <s:textfield
															id="nsrsContribution" name="nsrsContribution" style="width:70px;"/>
													</div>
													</td>
													<td>
													<div style="float: left; ">
														<label for="CX" style="display: block;" class="ptslabel">EMDA</label> <s:textfield
															id="emdaContribution" name="emdaContribution" style="width:70px;"/>
													</div>
													</td>
													<td>
													<div style="float: left;">
														<label for="OneTalk" style="display: block;" class="ptslabel">OneTalk</label> <s:textfield
															id="cmproxyContribution" name="cmproxyContribution" style="width:70px;"/>
													</div>
													</td>
													<td>
													<div style="float: left;">
														<label for="Admin" style="display: block;" class="ptslabel">Admin</label> <s:textfield
															id="adminContribution" name="adminContribution" style="width:70px;"/>
													</div>
													</td>
												</table>
											</td>
										...
										<tr>
											...
											<td><s:textfield name="competencyScore" id="competencyScore"
													theme="simple" cssStyle="width:173px;"></s:textfield></td>
											<td class="ptslabel" align="right"><s:text
