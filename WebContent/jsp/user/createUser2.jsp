									...
									<table cellspacing="10">
													...
													<tr>
														...
														<td>
															<div style="float: left;">
																...
																<s:textfield id="seContribution"
																	name="seContribution" style="width:70px;" />
															</div>
														</td>
														<td>
															<div style="float: left;">
														...
														<td>
															<div style="float: left;">
																...
																<s:textfield id="pmContribution"
																	name="pmContribution" style="width:70px;" />
															</div>
														</td>
														<td>
															<div style="float: left;">
										...
										<tr>
											...
											<td><s:textfield name="competencyScore"
													id="competencyScore" theme="simple" cssStyle="width:173px;"></s:textfield></td>
											<td class="ptslabel" align="right"><s:text
